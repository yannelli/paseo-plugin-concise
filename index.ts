...
export default function contribute(plugin: PluginContext) {
  ...
  plugin.addSidebarItem({ id: "main", title: "Be concise", icon: "ListFilter", surface: "main" });
  plugin.addWorkspacePanel({ id: "workspace", title: "Be concise", icon: "ListFilter", context: "workspace", locations: ["workspace", "explorer"], Component: WorkspacePanel });
  plugin.addCommandCenterItem({ id: "open", title: "Be concise: activity and configuration", icon: "ListFilter", context: "global",
    keywords: ["concise", "rules", "stats", "hooks"], onSelect({ openSurface }) { openSurface("main"); } });
  plugin.addCommandCenterItem({ id: "open-workspace", title: "Be concise: this workspace", icon: "ListFilter", context: "workspace",
